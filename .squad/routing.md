...
|-----------|----------|----------|
| Architecture, scope, decisions | Dallas | Project structure, API design, model selection |
| Core library, inference, downloads | Ripley | WhisperClient, model pipeline, ONNX inference |
| Testing, QA, edge cases | Lambert | Unit tests, integration tests, test coverage |
| Docs, samples, NuGet packaging | Ash | README, API docs, sample apps, .csproj metadata |
| Code review | Dallas | Review PRs, check quality, architecture consistency |
| Testing review | Lambert | Verify test coverage, reject untested code |
